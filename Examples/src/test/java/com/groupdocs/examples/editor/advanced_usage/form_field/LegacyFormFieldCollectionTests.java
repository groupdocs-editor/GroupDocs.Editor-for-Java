...
class LegacyFormFieldCollectionTests extends TestsSetUp {


    @Test
    void testRun() {
        FormFieldCollection collection = LegacyFormFieldCollection.run(SampleFiles.LEGACY_FORM_FIELDS_DOCX);
