...
class FixInvalidFormFieldCollectionAndSaveTests extends TestsSetUp {

    @Test
    void testRun() {
        Path outputPath = FixInvalidFormFieldCollectionAndSave.run(SampleFiles.LEGACY_FORM_FIELDS_DOCX);
